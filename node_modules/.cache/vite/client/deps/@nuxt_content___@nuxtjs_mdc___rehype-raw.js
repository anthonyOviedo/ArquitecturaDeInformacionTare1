...
import {
  ...
  pointEnd,
  pointStart
} from "./chunk-4GTXHKNR.js";
import {
  Parser,
  TokenizerMode,
  html_exports,
  token_exports
} from "./chunk-ITUG525O.js";
import {
  visit
} from "./chunk-4LXI5QDP.js";
import "./chunk-QUQR4M52.js";
import {
  ok
...
function element(state, node) {
  ...
  state.schema = node.namespaceURI === webNamespaces.svg ? svg4 : html4;
  let index = -1;
  const properties = {};
      ...
      if (location2.attrs) {
        for (key in location2.attrs) {
          if (own.call(location2.attrs, key)) {
            properties[find2(state.schema, key).property] = position(
              location2.attrs[key]
            );
          }
        }
...
Schema3.prototype.property = {};
Schema3.prototype.normal = {};
Schema3.prototype.space = null;
...
Info3.prototype.space = null;
Info3.prototype.boolean = false;
Info3.prototype.booleanish = false;
Info3.prototype.overloadedBoolean = false;
Info3.prototype.number = false;
Info3.prototype.commaSeparated = false;
Info3.prototype.spaceSeparated = false;
Info3.prototype.commaOrSpaceSeparated = false;
Info3.prototype.mustUseProperty = false;
Info3.prototype.defined = false;

// node_modules/property-information/lib/util/types.js
var types_exports3 = {};
__export(types_exports3, {
  boolean: () => boolean3,
  booleanish: () => booleanish3,
  commaOrSpaceSeparated: () => commaOrSpaceSeparated3,
  commaSeparated: () => commaSeparated3,
  number: () => number3,
  overloadedBoolean: () => overloadedBoolean3,
  spaceSeparated: () => spaceSeparated3
});
var powers3 = 0;
var boolean3 = increment3();
var booleanish3 = increment3();
var overloadedBoolean3 = increment3();
var number3 = increment3();
var spaceSeparated3 = increment3();
var commaSeparated3 = increment3();
var commaOrSpaceSeparated3 = increment3();
function increment3() {
  return 2 ** ++powers3;
}

// node_modules/property-information/lib/util/defined-info.js
var checks3 = Object.keys(types_exports3);
var DefinedInfo3 = class extends Info3 {
  /**
   * @constructor
   * @param {string} property
   * @param {string} attribute
  ...
  constructor(property, attribute, mask, space) {
    ...
    if (typeof mask === "number") {
      while (++index < checks3.length) {
        const check = checks3[index];
        mark3(this, checks3[index], (mask & types_exports3[check]) === types_exports3[check]);
      }
    }
  }
};
DefinedInfo3.prototype.defined = true;
function mark3(values, key, value) {
  if (value) {
    values[key] = value;
  }
}
...
function create3(definition) {
  ...
  return new Schema3(property, normal, definition.space);
}
...
var svg5 = create3({
  ...
  transform: caseSensitiveTransform3,
  properties: {
    about: commaOrSpaceSeparated3,
    accentHeight: number3,
    accumulate: null,
    additive: null,
    alignmentBaseline: null,
    alphabetic: number3,
    ...
    hrefLang: null,
    horizAdvX: number3,
    horizOriginX: number3,
    horizOriginY: number3,
    id: null,
    ideographic: number3,
    imageRendering: null,
    initialVisibility: null,
    ...
    k3: number3,
    k4: number3,
    kernelMatrix: commaOrSpaceSeparated3,
    kernelUnitLength: null,
    keyPoints: null,
    // SEMI_COLON_SEPARATED
    keySplines: null,
    ...
    overflow: null,
    overlay: null,
    overlinePosition: number3,
    overlineThickness: number3,
    paintOrder: null,
    panose1: null,
    path: null,
    pathLength: number3,
    ...
    primitiveUnits: null,
    propagate: null,
    property: commaOrSpaceSeparated3,
    r: null,
    radius: null,
    referrerPolicy: null,
    refX: null,
    refY: null,
    rel: commaOrSpaceSeparated3,
    rev: commaOrSpaceSeparated3,
    renderingIntent: null,
    repeatCount: null,
    repeatDur: null,
    requiredExtensions: commaOrSpaceSeparated3,
    requiredFeatures: commaOrSpaceSeparated3,
    requiredFonts: commaOrSpaceSeparated3,
    requiredFormats: commaOrSpaceSeparated3,
    resource: null,
    restart: null,
    result: null,
    rotate: null,
    ...
    slope: null,
    snapshotTime: null,
    specularConstant: number3,
    specularExponent: number3,
    spreadMethod: null,
    spacing: null,
    startOffset: null,
    stdDeviation: null,
    ...
    stopColor: null,
    stopOpacity: null,
    strikethroughPosition: number3,
    strikethroughThickness: number3,
    string: null,
    stroke: null,
    strokeDashArray: commaOrSpaceSeparated3,
    strokeDashOffset: null,
    strokeLineCap: null,
    strokeLineJoin: null,
    strokeMiterLimit: number3,
    strokeOpacity: number3,
    strokeWidth: null,
    style: null,
    surfaceScale: number3,
    syncBehavior: null,
    syncBehaviorDefault: null,
    syncMaster: null,
    syncTolerance: null,
    syncToleranceDefault: null,
    systemLanguage: commaOrSpaceSeparated3,
    tabIndex: number3,
    tableValues: null,
    target: null,
    targetX: number3,
    ...
    transformBehavior: null,
    type: null,
    typeOf: commaOrSpaceSeparated3,
    to: null,
    transform: null,
    transformOrigin: null,
    u1: null,
    u2: null,
    underlinePosition: number3,
    underlineThickness: number3,
    unicode: null,
    unicodeBidi: null,
    unicodeRange: null,
    unitsPerEm: number3,
    values: null,
    vAlphabetic: number3,
    vMathematical: number3,
    vectorEffect: null,
    vHanging: number3,
    vIdeographic: number3,
    version: null,
    vertAdvY: number3,
    vertOriginX: number3,
    vertOriginY: number3,
...
function find3(schema, value) {
  ...
  if (normal.length > 4 && normal.slice(0, 4) === "data" && valid3.test(value)) {
    if (value.charAt(4) === "-") {
      const rest = value.slice(5).replace(dash3, camelcase3);
      prop = "data" + rest.charAt(0).toUpperCase() + rest.slice(1);
    } else {
      const rest = value.slice(4);
      if (!dash3.test(rest)) {
        let dashes = rest.replace(cap3, kebab3);
        if (dashes.charAt(0) !== "-") {
          dashes = "-" + dashes;
        }
        value = "data" + dashes;
...
var html6 = merge3([xml3, xlink3, xmlns3, aria3, html5], "html");
var svg6 = merge3([xml3, xlink3, xmlns3, aria3, svg5], "svg");
...
function toParse5(tree, options) {
  ...
  return one2(tree, space === "svg" ? svg6 : html6);
}
...
//# sourceMappingURL=@nuxt_content___@nuxtjs_mdc___rehype-raw.js.map
