...
${content(node, context)}`.trim();
  ...
  function containerComponent(node, _, context) {
    ...
    if ((value + attributesText).length > (opts?.attributes?.maxLength || 80) || Object.keys(node.fmAttributes).length > 0 || node.children?.some((child) => child.type === "componentContainerSection")) {
...
//# sourceMappingURL=@nuxt_content___@nuxtjs_mdc___remark-mdc.js.map
