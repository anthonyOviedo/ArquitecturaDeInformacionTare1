...
import { defineComponent, withCtx, createTextVNode, useSSRContext } from 'file:///home/tony/proyectos/tarea1/ArquitecturaDeInformacionTare1/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderComponent } from 'file:///home/tony/proyectos/tarea1/ArquitecturaDeInformacionTare1/node_modules/vue/server-renderer/index.mjs';
    ...
    const categorias = [
      {
        id: "sucesos",
        nombre: "Sucesos",
        descripcion: "Cobertura de emergencias, incidentes relevantes y acontecimientos que afectan la vida cotidiana en el pa\xEDs."
      },
      {
        id: "deportes",
        nombre: "Deportes",
        descripcion: "Resultados, an\xE1lisis y contexto de las principales competencias deportivas a nivel nacional e internacional."
      },
      {
        id: "espectaculos",
        nombre: "Espect\xE1culos",
        descripcion: "Noticias sobre cine, m\xFAsica, teatro y el d\xEDa a d\xEDa de las figuras del entretenimiento."
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(_attrs)}><header><h1>Blog de noticias nacionales</h1><p> Este blog re\xFAne noticias nacionales organizadas en tres categor\xEDas principales: sucesos, deportes y espect\xE1culos. Cada nota incluye su autor, fecha de publicaci\xF3n y al menos una fotograf\xEDa relacionada. </p></header><section><h2>Categor\xEDas de noticias</h2><ul><!--[-->`);
...
//# sourceMappingURL=index-D0P-I5VU.mjs.map
