...
import { defineComponent, computed, withAsyncContext, unref, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file:///home/tony/proyectos/tarea1/ArquitecturaDeInformacionTare1/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderComponent } from 'file:///home/tony/proyectos/tarea1/ArquitecturaDeInformacionTare1/node_modules/vue/server-renderer/index.mjs';
import { u as useRoute } from './server.mjs';
import { u as useAsyncData, q as queryContent } from './query-B157ickb.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)}><header><h1>${ssrInterpolate(unref(nombreCategoria))}</h1><p> Noticias de la categor\xEDa <strong>${ssrInterpolate(unref(nombreCategoria))}</strong>. Seleccione una nota para leerla completa. </p></header>`);
      if ((_a = unref(articulos)) == null ? void 0 : _a.length) {
        _push(`<div><!--[-->`);
        ssrRenderList(unref(articulos), (articulo) => {
          ...
          _push(`</h2><p>${ssrInterpolate(articulo.author)} \xB7 ${ssrInterpolate(articulo.date)}</p><p>${ssrInterpolate(articulo.description)}</p>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: articulo._path
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
        ...
        _push(`<p> No se encontraron noticias para esta categor\xEDa. </p>`);
      }
      _push(`</section>`);
    };
  }
...
//# sourceMappingURL=_categoria_-k9BNkaiS.mjs.map
