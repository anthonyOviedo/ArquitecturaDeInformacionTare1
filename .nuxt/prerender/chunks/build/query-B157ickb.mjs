import { computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, toRef, nextTick, unref, defineComponent, createElementBlock, provide, cloneVNode, h } from 'file:///home/tony/proyectos/tarea1/ArquitecturaDeInformacionTare1/node_modules/vue/index.mjs';
import { debounce } from 'file:///home/tony/proyectos/tarea1/ArquitecturaDeInformacionTare1/node_modules/perfect-debounce/dist/index.mjs';
import { b as useNuxtApp, c as asyncDataDefaults, a as useRuntimeConfig, d as createError, e as useRequestEvent } from './server.mjs';
import { withBase, withLeadingSlash, joinURL, withoutTrailingSlash } from 'file:///home/tony/proyectos/tarea1/ArquitecturaDeInformacionTare1/node_modules/ufo/dist/index.mjs';
...
function createAsyncData(nuxtApp, key, _handler, options, initialCachedData) {
  ...
  const handler = !((_c = nuxtApp.ssrContext) == null ? void 0 : _c._sharedPrerenderCache) ? _handler : (nuxtApp2, options2) => {
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Td4GBVeS.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-B157ickb.mjs.map
